...
# BioLockJ.v1.4.0: ${scriptDir}/07.0_GenMod.sh
...
touch "${scriptDir}/07.0_GenMod.sh_Started"

exec 1>${logDir}/07.0_GenMod.log
exec 2>&1

cd ${scriptDir}

function scriptFailed() {
    echo "Line #${2} failure status code [ ${3} ]:  ${1}" >> "${scriptDir}/07.0_GenMod.sh_Failures"
    exit ${3}
}
...
touch "${scriptDir}/07.0_GenMod.sh_Success"
