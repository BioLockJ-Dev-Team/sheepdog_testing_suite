...
# BioLockJ v1.4.0: ${scriptDir}/MAIN_06_OneLine.sh
...
touch "${scriptDir}/MAIN_06_OneLine.sh_Started"
...
function scriptFailed() {
    echo "Line #${2} failure status code [ ${3} ]:  ${1}" >> "${scriptDir}/MAIN_06_OneLine.sh_Failures"
    exit ${3}
}
...
touch "${scriptDir}/MAIN_06_OneLine.sh_Success"
